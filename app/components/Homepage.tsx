      ...
      <main>
        <div className="container mx-auto px-5">
          {homepageData.map((item, index) => {
            // Respect the original code where the third section ("Ocean") has a "p-7" padding class on the grid text container
            ...
            // Respect the original code where the first section has "mb-8 md:mb-16" on the image wrapper
            const imageWrapperClass = index === 0 
              ? "image-container mb-8 md:mb-16" 
              : "image-container";
